...
public class CanteenListFragment extends RuntimePermissionsActivity implements LocationListener {
...
//    }
    ...
    public void onResume() {
        super.onResume();
        CanteenListFragment.super.requestAppPermissions(new
                        String[]{Manifest.permission.ACCESS_COARSE_LOCATION,
                        Manifest.permission.ACCESS_FINE_LOCATION}, R.string
                        .text_location_permission
                , REQUEST_PERMISSIONS);
    }
    ...
    public void updateCanteen() {
        ...
        mCanteenArrayList.add(new Canteen("CET Canteen", getString(R.string.ju_canteen), findDistance(22.495944d, 88.371803d, location), KEY_CET, 22.495944d, 88.371803d, "10:00 AM - 5:00 PM", ""));
...
//            Toast.makeText(getActivity(), "Location disabled", Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        locationManager = (LocationManager) getActivity().getSystemService(Context.LOCATION_SERVICE);
        snack = Snackbar.make(getActivity().findViewById(android.R.id.content), "Waiting for location lock.", Snackbar.LENGTH_INDEFINITE)
