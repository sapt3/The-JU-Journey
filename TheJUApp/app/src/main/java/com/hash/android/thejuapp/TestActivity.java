...
//                progressBar.setVisibility(View.GONE);
                ...
                viewHolder.setImage(model.getImageURL(), TestActivity.this);
            ...
            public FeedHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                viewHolder.setOnClickListener(new FeedHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent i = new Intent(TestActivity.this, DetailsFeedActivity.class);
                        ...
                        ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(TestActivity.this, pair1);
