...
public class CanteenMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView timeTV = (TextView) findViewById(R.id.timingsTextView);
        timeTV.setText(canteen.longTimings);
    ...
    private void updateUI(String key) {
        ...
        switch (key) {
            ...
            case KEY_CET:
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("RICE WITH MEAT(CHICKEN)", "50"));
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("MOGHLAI PAROTA", "50"));
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("CHANA BATORA", "25"));
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("PLAIN PAROTA", "5"));
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("ALUDAM", "10"));
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("CHICKEN GHUGHAI", "10"));
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("STUFF ALOODAM(1pcs)", "15"));
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("GAJA", "6"));
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("NAN PAROTA(1 PC)", "5"));
                ...
                mArrayList.add(new com.hash.android.thejuapp.Model.MenuItem("FISH KACHAURI", "25"));
                break;
