...
public class AboutClubFragmentFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Club club = getArguments().getParcelable("CLUB");
        if (club != null) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Club club = getArguments().getParcelable("CLUB");
        ...
        if (club == null) {
            ...
            Button button = rootView.findViewById(R.id.clubContactButton);
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Uri uriUrl = null;
                    if (club.clubLink != null) {
                        uriUrl = Uri.parse(club.clubLink);
                        Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                        startActivity(launchBrowser);
                    } else
                        Toast.makeText(getActivity(), "Invalid webpage!", Toast.LENGTH_SHORT).show();
